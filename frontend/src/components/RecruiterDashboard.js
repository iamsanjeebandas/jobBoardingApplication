    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="w-64 bg-gray-800 text-gray-300 p-4 flex flex-col justify-between">
                <div>
                    <h2 className="text-xl font-bold mb-10">Recruiter Dashboard</h2>
                    <ul>
                        {/* <li>
                            <Link
                                to="/"
                        ...
                        <li>
                            <Link
                                to="/recruiter-dashboard/posted-jobs"
                                className={`flex items-center py-4 px-4 rounded ${location.pathname === "/recruiter-dashboard/posted-jobs" ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
                            >
                                <FaClipboardList className="mr-3" /> Posted Jobs
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/recruiter-dashboard/applications"
                                className={`flex items-center py-4 px-4 rounded ${location.pathname === "/recruiter-dashboard/applications" ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
                            >
                                <FaClipboardList className="mr-3" /> Applications
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/recruiter-dashboard/profile"
                                className={`flex items-center py-4 px-4 rounded ${location.pathname === "/recruiter-dashboard/profile" ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
                            >
            ...
            <div className="flex-1 p-8 overflow-y-auto"> {/* Add overflow-y-auto here */}
                {/* Display Recruiter Dashboard content or nested routes */}
                <Outlet />
            </div>
        </div>
    );

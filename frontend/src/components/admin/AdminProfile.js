...
const GET_USER_PROFILE = gql`
  query getUserProfile($recruiterId: ID!) {
...
const AdminProfile = () => {
    ...
    const [updateRecruiterProfile] = useMutation(UPDATE_USER_PROFILE);
    ...
    return (
        <div className="p-8 max-w-3xl mx-auto bg-white shadow-lg rounded-xl space-y-6">
          <Toaster  position="bottom-right" /> {/* Add the Toaster component here to display notifications */}
